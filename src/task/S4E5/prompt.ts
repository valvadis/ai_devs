...
[rysunek mężczyzny z włosami w nieładzie, podpisany "RAV"]
...
Zatrzymam się tu na
jakiś czas.
[obok jest narysowana jaskinia z dopisanym siglem Iz 2:19]
...
To już jutro. [data dzisiejsza to 11 listopada 2024]
...
Na obrazku znajdują się fragmenty zapisane odręcznym pismem. Oto ich streszczenie:

Wszystko zostało zaplanowane i gotowe. Andrzej pojawi się niedługo. Barbara zapewnia, 
że to dobry krok. Jest mowa o trudności z dostaniem się do Luwrów oraz o ograniczeniach 
czasowych. Autor liczy na to, że Andrzejek będzie miał mało paliwa. Tankowanie nie jest
 możliwe. Wszystko zależy od umiejętności wykonania zadania, a zawiodły precyzyjne narzędzia. 
 Ważnym elementem jest również powrót do domu oraz zdjęcie zegarka.
 Jest również informacja, że autor musi dostać się do Lubawy koło Grudziądza.
 
Rafał wspomina, że przeniósł się do roku, w którym powstał chat GPT-2.
    </information>
    
    <objective>
        Na podstawie dostępnych informacji odpowiedź na przesłane pytania. Uwzględnij wszystkie fakty podane w tekście,
        w szczególności odwołania do wydarzeń.
                
        Jeśli w zadaniu jest prośba o konkretny format dat zwróć TYLKO datę w tym formacie.
    </objective>
`;
